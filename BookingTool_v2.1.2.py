...
def process_data():
    ...
    try:
        ...
        file2 = pd.read_csv(val_file2, delimiter='\t', header=None, encoding='utf-8', quotechar='"', 
                            names=['col1', 'accountnumber', 'id', 'timestamp', 'col5'], usecols=[0, 1, 2, 3, 4])

        file1['mitarbeiternummer'] = file1['mitarbeiternummer'].astype(int)
        ...
        # Filter out rows where 'accountnumber' is greater or equals 200
